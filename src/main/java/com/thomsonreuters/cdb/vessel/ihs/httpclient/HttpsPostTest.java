package com.thomsonreuters.cdb.vessel.ihs.httpclient;
...
public class HttpsPostTest {
	...
	public static void main(String[] args) throws Exception
	{
		...
		header.put("Authorization", "Basic dGhvc21pMTE0OjczNzc4Mw==");
		
		String Result=post("https://aiswebservices.ihs.com/AISSvc.svc/AIS/GetTargets", header, new HashMap<String, String>(), new StringEntity("{\"sinceSeconds\",\"15\"}") );
